...
HelloTriangle::HelloTriangle(UINT width, UINT height, wstring name) :
	m_width(width),
	m_height(height),
	m_title(name),
	m_frameIndex(0),
...
void HelloTriangle::LoadResource()
{
...
void HelloTriangle::GetHardwareAdapter(IDXGIFactory2* pFactory, IDXGIAdapter1** ppAdapter)
{
